...
Cach test nhanh
Test MainMenu
Mo scene Assets/Scenes/MainMenu.unity.
Bam Play.
Doi intro hien logo va menu.
Bam BAT DAU.
Kiem tra game load sang S01_CityPrototype.
Test S01
Mo scene Assets/Scenes/S01_CityPrototype.unity.
Chay Tools > Dong Chay Anh Hung > Rebuild S01 City Escape Zigzag.
Chay Tools > Dong Chay Anh Hung > Create S01 Chase Threat.
Bam Play.
Test route: tutorial start -> side route -> QTE blocker -> slow zone -> collapse zone.
Test S02
Mo scene Assets/Scenes/S02_UndergroundCave.unity.
Chay Tools > Dong Chay Anh Hung > Rebuild S02 Underground Cave.
Bam Play.
Test flow: intro -> ancient signs -> voices -> Hac Tinh descent -> TimeRift resonance -> 30s stabilization -> ending cutscene.
Test S03
Mo scene Assets/Scenes/S03.unity.
Chay Tools > Dong Chay Anh Hung > Rebuild S03 Combat Arena.
Bam Play.
Test flow: Wave bat dau -> ha het quai -> chon 1 trong 3 Blessing -> wave tiep theo.
Neu Unity Hub bao No active licenses, vao Manage licenses va kich hoat Unity Personal/Student truoc khi bam Play.
Ghi chu hien tai
...
Mot so warning System.Net.Http / System.IO.Compression den tu Unity AI / package editor, khong phai loi gameplay script.# Dong_Chay_Anh_Hung
